...
**************************************************/
// Library: Leadtools.Document.SheetEditor.d.ts
// Version:23.0.0.14
//***********************************************************************************************
//   Copyright (c) 1991-2026 Apryse Software Corp. ALL RIGHTS RESERVED.
//***********************************************************************************************
//***********************************************************************************************
//   Type definitions for Leadtools.Document.SheetEditor.js
//   Updated: 3/31/2026 13:13
//   Version: 23.0.0.14
//
//   Dependencies:
//      Leadtools.d.ts
...
declare module lt.Document.SheetEditor {
   ...
   interface SheetEditorActiveSheetChangedEventHandler extends lt.LeadEventHandler {
      (sender: any, e: SheetEditorActiveSheetChangedEventArgs): void;
   }

   class SheetEditorActiveSheetChangedEventType extends lt.LeadEvent {
   ...
   class SheetEditorActiveSheetChangedEventArgs extends lt.LeadEventArgs {
   ...
   interface SheetEditorDataChangedEventHandler extends lt.LeadEventHandler {
      (sender: any, e: SheetEditorDataChangedEventArgs): void;
   }

   class SheetEditorDataChangedEventType extends lt.LeadEvent {
   ...
   class SheetEditorDataChangedEventArgs extends lt.LeadEventArgs {
   ...
   interface SheetEditorSelectionChangedEventHandler extends lt.LeadEventHandler {
      (sender: any, e: SheetEditorSelectionChangedEventArgs): void;
   }

   class SheetEditorSelectionChangedEventType extends lt.LeadEvent {
   ...
   class SheetEditorSelectionChangedEventArgs extends lt.LeadEventArgs {
      get_sheetIndex(): number;
      get_range(): CellRange;
      sheetIndex: number; // read-only
   ...
   interface SheedEditorSheetStateChangedEventHandler extends lt.LeadEventHandler {
      (sender: any, e: SheedEditorSheetStateChangedEventArgs): void;
   }

   class SheedEditorSheetStateChangedEventType extends lt.LeadEvent {
   ...
   class SheedEditorSheetStateChangedEventArgs extends lt.LeadEventArgs {
      get_sheetIndex(): number;
   ...
   interface SheetEditorInteractiveEventHandler extends lt.LeadEventHandler {
      (sender: any, e: SheetEditorInteractiveEventArgs): void;
   }

   class SheetEditorInteractiveEventType extends lt.LeadEvent {
   ...
   class SheetEditorInteractiveEventArgs extends lt.LeadEventArgs {
   ...
   class SheetEditorCreateOptions {
      ...
      add_ready(value: lt.LeadEventHandler): void;
      remove_ready(value: lt.LeadEventHandler): void;
      ...
      ready: lt.LeadEventType; // read-only
   }
   ...
   class SheetEditor {
      ...
      enterEditMode(): void;
      exitEditMode(): void;
      onSizeChanged(e: lt.LeadEventArgs): void;
      dispose(): void;
      get_document(): lt.Document.LEADDocument;
      setDocument(doc: lt.Document.LEADDocument): any;
   ...
   class LEADWorkbook {
      ...
      exportWorkbook(fileName: string): any;
      document: lt.Document.LEADDocument; // read-only
   ...
   class SheetImage {
      getImage(): string;
      get_displayBounds(): lt.LeadRectD;
      displayBounds: lt.LeadRectD; // read-only
   }

   class SheetImageOptions {
      get_displayBounds(): lt.LeadRectD;
      set_displayBounds(value: lt.LeadRectD): void;
      add_success(value: lt.LeadEventHandler): void;
      remove_success(value: lt.LeadEventHandler): void;
      add_fail(value: lt.LeadEventHandler): void;
      remove_fail(value: lt.LeadEventHandler): void;
      constructor();
      displayBounds: lt.LeadRectD;
      success: lt.LeadEventType; // read-only
      fail: lt.LeadEventType; // read-only
   }

   class SheetImages {
      addImageWithOptions(source: string, options: SheetImageOptions): void;
      addImage(source: string, displayBounds: lt.LeadRectD): void;
      get_count(): number;
