...
declare module lt.Annotations.Rendering {
   ...
   class AnnHtml5RenderingEngine extends lt.Annotations.Engine.AnnRenderingEngine {
      ...
      static get_winformsEngineCompatible(): boolean;
      static set_winformsEngineCompatible(value: boolean): void;
      ...
      static winformsEngineCompatible: boolean;
   }
   ...
   class SvgDrawingHelper {
      ...
      static drawEllipse2(element: HTMLElement, rect: lt.LeadRectD, mapper: lt.Annotations.Engine.AnnContainerMapper, FixedStateOperations: lt.Annotations.Engine.AnnFixedStateOperations, angle: number): void;
      ...
      static drawEndingStyles(engine: AnnSvgRenderingEngine, element: HTMLElement, mapper: lt.Annotations.Engine.AnnContainerMapper, annObject: lt.Annotations.Engine.AnnObject): void;
      static createLineEndingElement(annElement: HTMLElement, annObject: lt.Annotations.Engine.AnnObject, mapper: lt.Annotations.Engine.AnnContainerMapper, endStyle: lt.Annotations.Engine.AnnLineEnding, lineStyleName: string): HTMLElement;
   ...
   class AnnSvgLineEndingRenderer {
      render(element: HTMLElement, mapper: lt.Annotations.Engine.AnnContainerMapper, lineEnding: lt.Annotations.Engine.AnnLineEnding, lineStart: lt.LeadPointD, lineEnd: lt.LeadPointD, operations: lt.Annotations.Engine.AnnFixedStateOperations): void;
      constructor();
   }
   ...
   class AnnSvgHelpers {
      ...
      static getChildId(parentId: string, childId: string): string;
