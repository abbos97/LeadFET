...
declare module lt.Annotations.Automation {
   ...
   class AnnAutomation {
      ...
      get_canLock(): boolean;
      get_canDeleteControlPoint(): boolean;
      get_canAddControlPoint(): boolean;
      ...
      canDeleteControlPoint: boolean; // read-only
      canAddControlPoint: boolean; // read-only
   ...
   class AnnAutomationManager {
      ...
      add_currentStickyNoteTypeChanged(value: lt.LeadEventHandler): void;
      remove_currentStickyNoteTypeChanged(value: lt.LeadEventHandler): void;
      get_currentStickyNoteType(): lt.Annotations.Engine.AnnStickyNoteType;
      set_currentStickyNoteType(value: lt.Annotations.Engine.AnnStickyNoteType): void;
      ...
      currentStickyNoteType: lt.Annotations.Engine.AnnStickyNoteType;
      ...
      currentStickyNoteTypeChanged: lt.LeadEventType; // read-only
   }
