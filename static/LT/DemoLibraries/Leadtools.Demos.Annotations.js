    ...
    (function (Demos) {
        ...
        (function (Annotations) {
            var SolidBrushPage = /** @class */ (function () {
                ...
                SolidBrushPage.prototype.initialize = function (brush) {
                    var _this = this;
                    // Reset all our saved info
                    this.clear();
                    // If we already have a solid brush then use it to make UI updates it , otherwise create default one 
                    if (brush instanceof lt.Annotations.Engine.AnnSolidColorBrush)
                        this._solidBrush = brush;
                    else
                        this._solidBrush = lt.Annotations.Engine.AnnSolidColorBrush.create("transparent");
                    // Add solid brush UI
                    var $container1 = $(document.createElement("div")).addClass("ann-dlg-property");
                    ...
                    $container1.append($row0);
                    $container1.append($row1);
                    this._pageElement.append($container1);
                };
            ...
            var HatchBrushPage = /** @class */ (function () {
                ...
                HatchBrushPage.prototype.initialize = function (brush) {
                    var _this = this;
                    // Reset all our saved info
                    this.clear();
                    // If we already have a hatch brush then use it to make UI updates it , other wise create default one 
                    if (brush instanceof lt.Annotations.Engine.AnnHatchBrush)
                        this._hatchBrush = brush;
                    else {
                    ...
                    this._pageElement.append($container1);
                    // Foreground color
                    var $container2 = $(document.createElement("div")).addClass("ann-dlg-property");
                    ...
                    this._pageElement.append($container2);
                    // Hatch style
                    var $container3 = $(document.createElement("div")).addClass("ann-dlg-property");
                    ...
                    $row5.append($span);
                    this._hatchStyleList = ["Horizontal", "Vertical", "ForwardDiagonal", "BackwardDiagonal", "Cross", "DiagonalCross", "Percent05", "Percent10", "Percent20", "Percent25", "Percent50", "Percent75", "Percent90"];
                    // Create the <option> elements
                    if (this._hatchStyleList && this._hatchStyleList.length) {
                        ...
                        if (this._hatchBrush.hatchStyle < 13) {
                    ...
                    $container3.append($row4);
                    $container3.append($row5);
                    this._pageElement.append($container3);
                };
                ...
                HatchBrushPage.prototype.updateBrush = function () {
                    ...
                    var selectedStyleIndex = this._hatchStyleList.indexOf(this.$_hatchStyleSelect.val());
                    if (selectedStyleIndex < 10) // all styles until Percent25 
                     {
                        this._hatchBrush.hatchStyle = selectedStyleIndex;
                    }
                    else { // Percent50,Percent75,Percent90
                        if (selectedStyleIndex == 10) {
                            this._hatchBrush.hatchStyle = lt.Annotations.Engine.AnnHatchStyle.percent50;
                        }
                        else if (selectedStyleIndex == 11) {
                            this._hatchBrush.hatchStyle = lt.Annotations.Engine.AnnHatchStyle.percent75;
                        }
                        else if (selectedStyleIndex == 12) {
                            this._hatchBrush.hatchStyle = lt.Annotations.Engine.AnnHatchStyle.percent90;
                        }
                    }
                };
            ...
            var LinearGradientBrushPage = /** @class */ (function () {
                ...
                LinearGradientBrushPage.prototype.initialize = function (brush) {
                    var _this = this;
                    // Reset all our saved info
                    this.clear();
                    // If we already have a linear gradient brush then use it to make UI updates it , other wise create default one 
                    if (brush instanceof lt.Annotations.Engine.AnnLinearGradientBrush)
                        this._linearGradientBrush = brush;
                    else {
                    ...
                    var $container1 = $(document.createElement("div")).addClass("ann-dlg-property");
                    var $row0 = $(document.createElement("div")).addClass("dropdown").attr("title", "Gradient Mode");
                    var $label = $(document.createElement("label")).addClass("input-label").text("Gradient Mode");
                    $row0.append($label);
                    // <select onchange=... > </select>
                    var $row1 = $(document.createElement("div")).addClass("dropdown").attr("title", "Gradient Mode");
                    ...
                    this._pageElement.append($container3);
                    // Second Stop color
                    var $container4 = $(document.createElement("div")).addClass("ann-dlg-property");
                    ...
                    $container4.append($row6);
                    $container4.append($row7);
                    this._pageElement.append($container4);
                    // Second Stop offset 
                    var $container5 = $(document.createElement("div")).addClass("ann-dlg-property");
                    ...
                    $container5.append($row8);
                    $container5.append($row9);
                    this._pageElement.append($container5);
                };
            ...
            var BrushDialog = /** @class */ (function () {
                function BrushDialog(root, selectors) {
                    ...
                    this._onHideClicked = function () {
                        ...
                        if (_this._automation != null) {
                            if (_this.el.solidBrush.tab.hasClass(BrushDialog.selectedClass) && _this._solidBrushPage.solidBrush != null) {
                                newBrush = _this._solidBrushPage.solidBrush;
                                needsInvalidate = true;
                            }
                            else if (_this.el.hatchBrush.tab.hasClass(BrushDialog.selectedClass) && _this._hatchBrushPage.hatchBrush != null) {
                                newBrush = _this._hatchBrushPage.hatchBrush;
                                needsInvalidate = true;
                            }
                            else if (_this.el.linearGradientBrush.tab.hasClass(BrushDialog.selectedClass) && _this._linearGradientBrushPage.linearGradientBrush != null) {
                                newBrush = _this._linearGradientBrushPage.linearGradientBrush;
                                needsInvalidate = true;
                            }
                            // Re-draw with new selected brush
                            if (needsInvalidate) {
                                // Are we updating a group of objects ?
                                if (_this.automation.currentEditObject instanceof lt.Annotations.Engine.AnnSelectionObject) {
                                    var selectionObject = _this.automation.currentEditObject;
                                    for (var i = 0; i < selectionObject.selectedObjects.count; ++i) {
                                        selectionObject.selectedObjects.item(i).fill = newBrush.clone();
                                    }
                                }
                                else {
                                    _this.automation.currentEditObject.fill = newBrush.clone();
                                }
                                _this.automation.invalidate(lt.LeadRectD.empty);
                            }
                            if (_this.onHide)
                                _this.onHide();
                            _this.inner.hide();
                ...
                Object.defineProperty(BrushDialog.prototype, "automation", {
                    get: function () { return this._automation; },
                    set: function (value) {
                        this._automation = value;
                    },
                ...
                BrushDialog.prototype.show = function () {
                    if (this._automation != null) {
                        var brush = null;
                        // If we have list of objects we need to update all of them
                        if (this._automation.currentEditObject instanceof lt.Annotations.Engine.AnnSelectionObject) {
                            // Take the last object brush 
                            var annSelectionObject = this._automation.currentEditObject;
                            brush = annSelectionObject.selectedObjects.item(annSelectionObject.selectedObjects.count - 1).fill;
                        }
                        else {
                            brush = this._automation.currentEditObject.fill;
                        }
                        // Set up the solid brush page
                        var $solidBrushTab = this.el.solidBrush.tab;
                        var $solidBrushPage = this.el.solidBrush.page;
                        this._solidBrushPage.initialize(brush);
                        // Set up the hatch brush page
                        var $hatchBrushTab = this.el.hatchBrush.tab;
                        var $hatchBrushPage = this.el.hatchBrush.page;
                        this._hatchBrushPage.initialize(brush);
                        ...
                        this._linearGradientBrushPage.initialize(brush);
                        // Add a class to specify the number of items for css styles
                        ...
                        else if (brush instanceof lt.Annotations.Engine.AnnHatchBrush) {
                            $hatchBrushTab.addClass(selectedClass);
                            $hatchBrushPage.addClass(selectedClass);
                        }
                        else if (brush instanceof lt.Annotations.Engine.AnnLinearGradientBrush) {
...
(function (lt) {
    ...
    (function (Demos) {
        ...
        (function (Annotations) {
            var SubTypesLoader;
            (function (SubTypesLoader_1) {
                /*
                   Loader will hold the defaults and will store the dynamic resources lists.
                   Client applications will need to create an instance of the loader.
                */
                var SubTypesLoader = /** @class */ (function () {
                    function SubTypesLoader() {
                        var _this = this;
                        // The extension
                        this.defaultsExtension = ".png";
                        ...
                        this.selectItem = function (index) {
                            _this.setCurrentSubType(index);
                            _this.updateRecents();
                            if (_this.quickSelect)
                                _this.quickSelect.hide();
                        };
                    }
                    SubTypesLoader.prototype.initialize = function (automationManager, element) {
                        var itemsList = this.createDefaultEntities();
                        var items = {};
                        ...
                        this.quickSelect = new SubTypesLoader_1.QuickSelect();
                        // Update
                        this.update();
                    };
                    // A mapping from default annotation object type to picture
                    SubTypesLoader.prototype.createDefaultEntities = function () {
                        var defaults = this.getSubTypesResources();
                        var defaultsPath = this.defaultsPath;
                        var defaultsExtension = this.defaultsExtension;
                        return defaults.map(function (tuple) {
                            var index = tuple[0];
                            var namePath = tuple[1];
                            var title = (tuple[2] || namePath);
                            var picture = new lt.Annotations.Engine.AnnPicture(defaultsPath + namePath + defaultsExtension);
                            return Entity.create(index, title, picture, "Default");
                        });
                    };
                    ;
                    SubTypesLoader.prototype.createDefaults = function (target) {
                        var items = this.createDefaultEntities();
                        items.forEach(function (item) {
                            target[item.index] = item.picture;
                        });
                    };
                    SubTypesLoader.prototype.update = function () {
                        var _this = this;
                        var resources = this.getResourcesInstance();
                        ...
                        itemsKeys.forEach(function (i) {
                            ...
                            resources[item.index] = item.picture;
                        });
                    };
                    SubTypesLoader.prototype.beginDraw = function () {
                        var manager = this.automationManager;
                        if (!manager)
                            return;
                        var currentObjectId = manager.currentObjectId;
                        if (this.annObjectId !== currentObjectId)
                            return;
                        this.updateRecents();
                        this.showQuickSelect();
                    };
                    SubTypesLoader.prototype.updateRecents = function () {
                        var entity = this.getSubTypeEntity();
                        if (!entity)
                            entity = this.items[0];
                    ...
                    SubTypesLoader.prototype.showQuickSelect = function () {
                        if (this.quickSelect)
                            this.quickSelect.show(this.recents, this.items, this.element, this.selectItem);
                    };
                    return SubTypesLoader;
                }());
                SubTypesLoader_1.SubTypesLoader = SubTypesLoader;
                ...
                SubTypesLoader_1.Entity = Entity;
                var RubberStampLoader = /** @class */ (function (_super) {
                    __extends(RubberStampLoader, _super);
                    function RubberStampLoader(automationManager, element) {
                        var _this = _super.call(this) || this;
                        _this.annObjectId = lt.Annotations.Engine.AnnObject.rubberStampObjectId;
                        _this.defaultsPath = "Resources/Objects/RubberStamps/";
                        _super.prototype.initialize.call(_this, automationManager, element);
                        return _this;
                    }
                    RubberStampLoader.prototype.getSubTypesResources = function () {
                        var defaults;
                        var AnnRubberStampType = lt.Annotations.Engine.AnnRubberStampType;
                        defaults = [
                            [AnnRubberStampType.stampApproved, "Approved", "Approved"],
                            [AnnRubberStampType.stampAssigned, "Assigned", "Assigned"],
                            [AnnRubberStampType.stampChecked, "Checked", "Checked"],
                            [AnnRubberStampType.stampClient, "Client", "Client"],
                            [AnnRubberStampType.stampCopy, "Copy", "Copy"],
                            [AnnRubberStampType.stampDraft, "Draft", "Draft"],
                            [AnnRubberStampType.stampExtended, "Extended", "Extended"],
                            [AnnRubberStampType.stampFax, "Fax", "Fax"],
                            [AnnRubberStampType.stampFaxed, "Faxed", "Faxed"],
                            [AnnRubberStampType.stampImportant, "Important", "Important"],
                            [AnnRubberStampType.stampInvoice, "Invoice", "Invoice"],
                            [AnnRubberStampType.stampNotice, "Notice", "Notice"],
                            [AnnRubberStampType.stampPaid, "Paid", "Paid"],
                            [AnnRubberStampType.stampOfficial, "Official", "Official"],
                            [AnnRubberStampType.stampOnFile, "OnFile", "On File"],
                            [AnnRubberStampType.stampPassed, "Passed", "Passed"],
                            [AnnRubberStampType.stampPending, "Pending", "Pending"],
                            [AnnRubberStampType.stampProcessed, "Processed", "Processed"],
                            [AnnRubberStampType.stampReceived, "Received", "Received"],
                            [AnnRubberStampType.stampRejected, "Rejected", "Rejected"],
                            [AnnRubberStampType.stampRelease, "Release", "Release"],
                            [AnnRubberStampType.stampSent, "Sent", "Sent"],
                            [AnnRubberStampType.stampShipped, "Shipped", "Shipped"],
                            [AnnRubberStampType.stampTopSecret, "TopSecret", "Top Secret"],
                            [AnnRubberStampType.stampUrgent, "Urgent", "Urgent"],
                            [AnnRubberStampType.stampVoid, "Void", "Void"]
                        ];
                        return defaults;
                    };
                    RubberStampLoader.prototype.getSubTypeEntity = function () {
                        var manager = this.automationManager;
                        var currentType = manager.currentRubberStampType;
                        var entity = this.items[currentType];
                        return entity;
                    };
                    RubberStampLoader.prototype.getResourcesInstance = function () {
                        return this.automationManager.resources.rubberStamps;
                    };
                    RubberStampLoader.prototype.setCurrentSubType = function (index) {
                        if (this.automationManager) {
                            this.automationManager.currentRubberStampType = index;
                        }
                    };
                    return RubberStampLoader;
                }(SubTypesLoader));
                SubTypesLoader_1.RubberStampLoader = RubberStampLoader;
                var StickyNoteLoader = /** @class */ (function (_super) {
                    __extends(StickyNoteLoader, _super);
                    function StickyNoteLoader(automationManager, element) {
                        var _this = _super.call(this) || this;
                        _this.annObjectId = lt.Annotations.Engine.AnnObject.stickyNoteObjectId;
                        _this.defaultsPath = "Resources/Objects/Notes/";
                        _super.prototype.initialize.call(_this, automationManager, element);
                        return _this;
                    }
                    StickyNoteLoader.prototype.getSubTypesResources = function () {
                        var defaults;
                        var AnnStickyNoteType = lt.Annotations.Engine.AnnStickyNoteType;
                        defaults = [
                            [AnnStickyNoteType.note, "NoteNote", "Note"],
                            [AnnStickyNoteType.comment, "NoteComment", "Comment"],
                            [AnnStickyNoteType.key, "NoteKey", "Key"],
                            [AnnStickyNoteType.help, "NoteHelp", "Help"],
                            [AnnStickyNoteType.insert, "NoteInsert", "Insert"],
                            [AnnStickyNoteType.paragraph, "NoteParagraph", "Paragraph"],
                            [AnnStickyNoteType.newParagraph, "NoteNewParagraph", "New Paragraph"],
                            [AnnStickyNoteType.custom, "", ""],
                            [AnnStickyNoteType.checkmark, "NoteCheckmark", "Checkmark"],
                            [AnnStickyNoteType.circle, "NoteCircle", "Circle"],
                            [AnnStickyNoteType.cross, "NoteCross", "Cross"],
                            [AnnStickyNoteType.check, "NoteCheck", "Check"],
                            [AnnStickyNoteType.star, "NoteStar", "Star"],
                            [AnnStickyNoteType.arrowLeft, "NoteArrowLeft", "Arrow Left"],
                            [AnnStickyNoteType.arrowRight, "NoteArrowRight", "Arrow Right"],
                            [AnnStickyNoteType.arrowUp, "NoteArrowUp", "Arrow Up"],
                            [AnnStickyNoteType.arrowDown, "NoteArrowDown", "Arrow Down"],
                            [AnnStickyNoteType.arrowUpLeft, "NoteArrowUpLeft", "Arrow Up Left"],
                            [AnnStickyNoteType.arrowUpRight, "NoteArrowUpRight", "Arrow Up Right"],
                            [AnnStickyNoteType.arrowDownLeft, "NoteArrowDownLeft", "Arrow Down Left"],
                            [AnnStickyNoteType.arrowDownRight, "NoteArrowDownRight", "Arrow Down Right"],
                            [AnnStickyNoteType.pointerLeft, "NotePointerLeft", "Pointer Left"],
                            [AnnStickyNoteType.pointerRight, "NotePointerRight", "Pointer Right"],
                            [AnnStickyNoteType.pointerUp, "NotePointerUp", "Pointer Up"],
                            [AnnStickyNoteType.pointerDown, "NotePointerDown", "Pointer Down"],
                            [AnnStickyNoteType.crosshairs, "NoteCrosshairs", "Crosshairs"]
                        ];
                        return defaults;
                    };
                    StickyNoteLoader.prototype.getSubTypeEntity = function () {
                        var currentType = this.automationManager.currentStickyNoteType;
                        var entity = this.items[currentType];
                        return entity;
                    };
                    StickyNoteLoader.prototype.getResourcesInstance = function () {
                        return this.automationManager.resources.notes;
                    };
                    StickyNoteLoader.prototype.setCurrentSubType = function (index) {
                        if (this.automationManager) {
                            this.automationManager.currentStickyNoteType = index;
                        }
                    };
                    return StickyNoteLoader;
                }(SubTypesLoader));
                SubTypesLoader_1.StickyNoteLoader = StickyNoteLoader;
            })(SubTypesLoader = Annotations.SubTypesLoader || (Annotations.SubTypesLoader = {}));
        })(Annotations = Demos.Annotations || (Demos.Annotations = {}));
    })(Demos = lt.Demos || (lt.Demos = {}));
})(lt || (lt = {}));
// *************************************************************
    ...
    (function (Demos) {
        ...
        (function (Annotations) {
            ...
            (function (SubTypesLoader) {
                ...
                SubTypesLoader.QuickSelect = QuickSelect;
            })(SubTypesLoader = Annotations.SubTypesLoader || (Annotations.SubTypesLoader = {}));
        })(Annotations = Demos.Annotations || (Demos.Annotations = {}));
    })(Demos = lt.Demos || (lt.Demos = {}));
})(lt || (lt = {}));
        ...
        (function (Annotations) {
            ...
            var AnnObjectEditor = /** @class */ (function () {
                function AnnObjectEditor(annObject) {
                    ...
                    // Stroke
                    if (annObject.get_supportsStroke() && !(annObject instanceof lt.Annotations.Engine.AnnHotspotObject)) {
                        var strokePropertyInfo = new Annotations.AnnPropertyInfo("Stroke", false, annObject.stroke, "Stroke", "Stroke the object", "", annObject.get_supportsStroke(), AnnStrokeEditor);
                    ...
                    if (isSingleElement) {
                        ...
                        if (item.htmlType === HTMLType.label) {
                            ...
                            $button.on("click", function () {
                                ...
                                brushDialog.automation = _this._automation;
                                brushDialog.show();
                            });
        ...
        (function (Annotations) {
            var ReviewsPage = /** @class */ (function () {
                ...
                ReviewsPage.prototype.updateContent = function (annObject, annContainer) {
                    ...
                    if (annContainer && !annContainer.isEnabled)
                        headerText += " (Disabled)";
